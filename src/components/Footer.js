        ...
        <Container>
          <Row className="pt-3 text-center">
            <Col xs={12} md={3}>
              ...
              />
              <h5 style={{fontFamily:"gabriola", fontSize:"2rem", color:"white", fontWeight:"bold"}}>Sunset Vacation</h5>
          ...
          <p className="text-white text-center py-3 m-0">Copyright &copy; Restricted || Sunset Vacation {new Date().getFullYear()}.</p>
        </Container>
      </div>
    </>
  );
